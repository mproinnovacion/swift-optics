...
extension ThrowingArraySetterOptic {
	public func mapFunc<Output>() -> MapThrowingArraySetter0<Self, Output> {
		.init(optic: self)
	}
	
	public func mapFunc<Input, Output>() -> MapThrowingArraySetter1<Self, Input, Output> {
		.init(optic: self)
	}
	
	public func mapFunc<Input0, Input1, Output>() -> MapThrowingArraySetter2<Self, Input0, Input1, Output> {
		.init(optic: self)
	}
	
	public func mapFunc<Input0, Input1, Input2, Output>() -> MapThrowingArraySetter3<Self, Input0, Input1, Input2, Output> {
		.init(optic: self)
	}
	
	public func mapFunc<Input0, Input1, Input2, Input3, Output>() -> MapThrowingArraySetter4<Self, Input0, Input1, Input2, Input3, Output> {
		.init(optic: self)
	}
	
	public func mapFunc<Input0, Input1, Input2, Input3, Input4, Output>() -> MapThrowingArraySetter5<Self, Input0, Input1, Input2, Input3, Input4, Output> {
		.init(optic: self)
	}
	
	public func mapFunc<Input0, Input1, Input2, Input3, Input4, Input5, Output>() -> MapThrowingArraySetter6<Self, Input0, Input1, Input2, Input3, Input4, Input5, Output> {
		.init(optic: self)
	}
}
